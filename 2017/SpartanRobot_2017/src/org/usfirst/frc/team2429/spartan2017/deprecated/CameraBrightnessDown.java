 ...
 *
 */
public class CameraBrightnessDown extends Command {

    public CameraBrightnessDown() {
    ...
    protected void execute() {
    	...
    	System.out.println("CameraBrightness lowerered to "+RobotMap.gearCameraBrightness+" at: " + String.format("%.2f",Timer.getFPGATimestamp())+"s");
    }
