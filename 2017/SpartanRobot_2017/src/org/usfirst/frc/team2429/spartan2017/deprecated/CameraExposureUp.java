 ...
 *
 */
public class CameraExposureUp extends Command {

    public CameraExposureUp() {
    ...
    protected void execute() {
    	...
    	System.out.println("CameraExposure raised to "+RobotMap.gearCameraExposure + " at: " + String.format("%.2f",Timer.getFPGATimestamp())+"s");
    }
