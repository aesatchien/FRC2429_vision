 ...
 *
 */
public class TestWheelLow extends Command {
    ...
    protected void initialize() {
    	setTimeout(60.0);
    	testPower = 0.1;
		System.out.println("TestWheelLow called at: " + String.format("%.2f", Timer.getFPGATimestamp()) + "s");
    ...
    protected void end() {
    	System.out.println("TestWheelLow ended at: " + String.format("%.2f", Timer.getFPGATimestamp()) + "s   after running " + String.format("%.2f", timeSinceInitialized()) + "s" );
