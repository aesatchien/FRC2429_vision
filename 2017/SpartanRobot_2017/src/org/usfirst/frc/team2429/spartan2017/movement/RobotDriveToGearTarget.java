 ...
 *
 */
public class RobotDriveToGearTarget extends Command {
	...
	protected void initialize() {
		...
		System.out.println("RobotDriveToGearTarget called at: " + String.format("%.2f", Timer.getFPGATimestamp()) + "s");
		...
		while (  (counter < 10) && (Robot.imageProcessor.gearTargetCount < 2) ){
			Robot.imageProcessor.gearTargetCount = gearTable.getNumber("targets", -1.0);
	...
	protected void end() {
		...
		if (isOperatorEnabled) {
			System.out.println(
					"RobotDriveToGearTarget ended at: " + String.format("%.2f", Timer.getFPGATimestamp()) + "s");
		} else {
			System.out.println("RobotDriveToGearTarget ended at: " + String.format("%.2f", Timer.getFPGATimestamp())
	...
	protected void interrupted() {
		System.out.println(
				"RobotDriveToGearTarget interrupted at: " + String.format("%.2f", Timer.getFPGATimestamp()) + "s");
		RobotMap.drivetrainRobot.mecanumDrive_Cartesian(0, 0, 0, 0);
